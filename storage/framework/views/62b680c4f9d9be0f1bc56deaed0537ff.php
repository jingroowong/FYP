...
<body>
    ...
    <div class="ml-5 mt-2 property container">
        ...
        <!-- Search Bar -->
        <form action="<?php echo e(route('properties.searchAll')); ?>" method="get" class="mb-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($property->propertyType); ?></td>
                            <td width="25%"><?php echo e($property->propertyAddress); ?></td>
                            <?php if( $property->propertyAvailability == true ): ?>
                            <td>Active until ( <?php echo e(\Carbon\Carbon::parse($property->expiredDate)->format('Y-m-d')); ?>)</td>
                            <?php else: ?>
                            <td>N/A</td>
                            <?php endif; ?>
            ...
            <div class="tab-pane fade" id="rentals">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($propertyRental->property->propertyID); ?></td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('payments.paymentReceiptAdmin', $propertyRental->propertyRentalID)); ?>"
                                    ...
                                    <a href="<?php echo e(route('payments.releaseAdmin', $propertyRental->propertyRentalID)); ?>"
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/admin/propertyIndex.blade.php ENDPATH**/ ?>