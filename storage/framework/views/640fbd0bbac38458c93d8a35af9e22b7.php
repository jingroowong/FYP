        ...
        <div class="row">
            ...
            <div>
                <?php if($appointment->status == "Pending"): ?>
                    ...
                    <a href="<?php echo e(route('appointments')); ?>" class="btn btn-secondary">Back</a>
                    <a href="<?php echo e(route('appointments.cancel', $appointment->appID)); ?>" class="btn btn-danger"> Confirm
                        Cancel</a>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/appointmentDelete.blade.php ENDPATH**/ ?>