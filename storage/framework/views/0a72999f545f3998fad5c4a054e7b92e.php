...
<link rel="stylesheet" href="<?php echo e(asset('/storage/css/SearchProperty.css')); ?>" media="screen">
<link rel="stylesheet"
...
<div class="container-fluid" style="margin-left:20px; ">
    <div class="row">
        ...
        <div class="col-md-8 custom-offset2">
            ...
            <div class="property-listing mb-3">
                <h6>Total <?php echo e($properties->count()); ?> results found</h6>
            </div>

            <div class="property-listing d-flex justify-content-between align-items-center">
    <h3>Rent Property Listings</h3>
    <form method="GET" action="<?php echo e(route('sort.properties')); ?>" id="sortForm">
        <?php echo csrf_field(); ?>
        <input type="hidden" name="properties" value="<?php echo e(json_encode($properties)); ?>">
    ...
    <div class="card">
        <div class="row no-gutters">
            <div class="col-md-4">
                <img src="<?php echo e(Storage::url($property->propertyPhotos[0]->propertyPath)); ?>"
            ...
            <div class="col-md-8">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-9">
                            <h5 class="card-title"><?php echo e($property->propertyName); ?></h5>
                            <p class="card-room-type"><?php echo e($property->roomType); ?></p>
                            <p class="card-property-type"><?php echo e($property->propertyType); ?> - <?php echo e($property->housingType); ?></p>
                            <p class="card-property-description"><?php echo e($property->propertyDesc); ?></p>
                            <div class="row">
                            <div class="col-md-6">
                                <p><i class="lab la-buffer"></i> <?php echo e($property->squareFeet); ?> SQ.FT</p>
                                <p><i class="las la-bed"></i> <?php echo e($property->bedroomNum); ?> bedroom(s)</p>
                            </div>
                            <div class="col-md-6">
                                <p><i class="las la-tools"></i> <?php echo e($property->furnishingType); ?></p>
                                <p><i class="las la-bath"></i> <?php echo e($property->bathroomNum); ?> bathroom(s)</p>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if($property->total_reviews > 0): ?>
                       
                                <p class="rating-text text-center" id="ratingText">
                                <?php if($property->average_rating >= 8.1): ?>
                                        <span class="excellent-text">Excellent <?php echo e(number_format($property->average_rating, 1)); ?></span>
                                    <?php elseif($property->average_rating >= 6.1): ?>
                                        <span class="good-text">Good <?php echo e(number_format($property->average_rating, 1)); ?></span>
                                    <?php elseif($property->average_rating >= 4.1): ?>
                                        <span class="average-text">Average <?php echo e(number_format($property->average_rating, 1)); ?></span>
                                    <?php elseif($property->average_rating >= 2.1): ?>
                                        <span class="bad-text">Bad <?php echo e(number_format($property->average_rating, 1)); ?></span>
                                    <?php else: ?>
                                        <span class="very-bad-text">Very Bad <?php echo e(number_format($property->average_rating, 1)); ?></span>
                                    <?php endif; ?>
                                </p>
                                <p class="review-text text-center"><?php echo e($property->total_reviews); ?> reviews</p>
                            <?php else: ?>
                            <p class="no-review text-center"> No reviews</p>
                          
                            <?php endif; ?>
                                <p class="rental-amount text-center">RM <?php echo e($property->rentalAmount); ?></p>
                                <a href="<?php echo e(route('properties.show', $property->propertyID)); ?>"
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 0;">
                        <p style="color: gray; font-style: italic; margin-bottom: 0;">
                            <i class="fa fa-clock"></i> Posted at <?php echo e(\Carbon\Carbon::parse($property->created_at)->diffForHumans()); ?>

                        </p>
                        <form id="wishlistForm<?php echo e($property->propertyID); ?>" action="<?php echo e(route('ToggleWishList')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="propertyID" id="propertyID" value="<?php echo e($property->propertyID); ?>">
                            <input type="hidden" name="tenantID" id="tenantID" value="<?php echo e(session('tenant') ? session('tenant')->tenantID : ''); ?>">
                            <i class="fas fa-bookmark wishlist-star" title="Add to Wishlist" id="wishlistStar<?php echo e($property->propertyID); ?>" style=" margin: 15px 20px 0 0; color: <?php echo e($wishlistData ? '#FFD700' : 'grey'); ?>"></i>
                        </form>
                    </div>
        ...
        <div class="wish-no-found">
            ...
            <a href="<?php echo e(route('propertyList')); ?>">Show All Property</a>
        </div>
        <?php endif; ?>
...
<div class="modal fade" id="advancedFilterModal">
    <div class="modal-dialog custom-modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('advanced.filter')); ?>" method="GET">
            <!-- Modal Body -->
            <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                ...
                <div class="sub">
                    ...
                    <div id="propertyTypeDetails" class="collapse show">
                        <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            ...
                            <?php if($filter->filterAttribute == "Property Type"): ?>
                            <label class="btn btn-dark active mr-2 rounded-2">
                                <input type="radio" name="propertyType" value="<?php echo e($filter->filterValue); ?>"
                                    id="allPropertyType" <?php echo e($filter->filterValue == 'All' ? 'checked' : ''); ?>>
                                <?php echo e($filter->filterValue); ?>
                ...
                <div class="sub">
                    ...
                    <div id="roomDetail" class="collapse show">
                        <div class="row">
                            <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($filter->filterAttribute == "Room Type"): ?>
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="roomType" id="house"
                                        value="<?php echo e($filter->filterValue); ?>">
                                    <label class="form-check-label"
                                        for="<?php echo e($filter->filterValue); ?>"><?php echo e($filter->filterValue); ?></label>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="sub">
                    ...
                    <div id="bathroomDetail" class="collapse show">
                        ...
                        <div class="row justify-content-center">
                            <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($filter->filterName == "Min Bathrooms"): ?>
                            <div class="form-check form-check-inline mx-2">
                                <input class="form-check-input" type="radio" name="bathroomCount" id="bathroom1"
                                    value="<?php echo e($filter->filterValue); ?>">
                                <label class="form-check-label mr-2" for="bathroom1"><?php echo e($filter->filterValue); ?></label>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="sub">
                    ...
                    <div id="furnishingDetail" class="collapse show">
                        ...
                        <div class="row justify-content-center">
                            <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($filter->filterAttribute == "Furnishing"): ?>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="<?php echo e($filter->filterAttribute); ?>"
                                    id="<?php echo e($filter->filterAttribute); ?>" value="<?php echo e($filter->filterValue); ?>">
                                <label class="form-check-label"
                                    for="<?php echo e($filter->filterAttribute); ?>"><?php echo e($filter->filterValue); ?></label>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                ...
                <div class="sub">
                    ...
                    <div id="postedDetails" class="collapse show">
                        ...
                        <div class="row">
                            <?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($filter->filterAttribute == "Posted Date"): ?>
                            <div class="col-md-4 mb-3">
                                <div class="form-check form-check-inline mx-2">
                                    <input class="form-check-input" type="radio" name="postedDate" id="bathroom1"
                                        value="<?php echo e($filter->filterValue); ?>">
                                    <label class="form-check-label mr-2"
                                        for="postedDate"><?php echo e($filter->filterValue); ?></label>
                                </div>
                            </div>
                            <?php endif; ?>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/propertyIndex.blade.php ENDPATH**/ ?>