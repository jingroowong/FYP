...
<body>
    ...
    <div class="ml-5 mt-2 container">
        <a href="<?php echo e(route('refunds')); ?>" class="btn btn-secondary">
            <i class="fas fa-arrow-left"></i> Back
        </a>
        <h2 class="mt-4 mb-4">Refund Application for Rental # <?php echo e($refund->propertyRentalID); ?></h2>

        <!-- Display Property Details -->

        <div class="property-details">
            <p><strong>Property Name :</strong> <?php echo e($refund->propertyRental->property->propertyName); ?></p>
            <p><strong>Property Address:</strong> <?php echo e($refund->propertyRental->property->propertyAddress); ?></p>
        </div>

        <div class="row">
            <!-- Display Property Photo -->
            <div class="col-md-6 propertyPhoto">
                <img src="<?php echo e(Storage::url($refund->propertyRental->property->propertyPhotos[0]->propertyPath)); ?>"
                    alt="Property Photo">
            </div>
        </div>
        ...
        <div class="payment-details mt-4">
            ...
            <table class="table">
                <tr>
                    ...
                    <td><strong> # <?php echo e($refund->propertyRental->propertyID); ?></strong></td>
                </tr>
                <tr>
                    <td>Requested by Tenant : </td>
                    <td><strong><?php echo e($refund->propertyRental->tenant->tenantName); ?>

                            (<?php echo e($refund->propertyRental->tenant->tenantPhone); ?>) </strong></td>
                </tr>

                <tr>
                    <td>Payment Date:</td>
                    <td><strong><?php echo e($refund->propertyRental->payment->paymentDate); ?></strong></td>
                </tr>
                <tr>
                    <td>Payment Amount:</td>
                    <td><strong>RM <?php echo e($refund->propertyRental->payment->paymentAmount); ?></strong></td>
                </tr>
                <tr>
                    <td>Payment Method:</td>
                    <td><strong><?php echo e($refund->propertyRental->payment->paymentMethod); ?></strong></td>
                </tr>
                <tr>
                    <td>Agent In Charge:</td>
                    <td><strong> <?php echo e($refund->propertyRental->property->agent->agentName); ?>

                            (<?php echo e($refund->propertyRental->property->agent->agentPhone); ?>)</strong></td>
                </tr>
                <tr>
                    <td>Reason:</td>
                    <td><strong><?php echo e($refund->refundReason); ?></strong>
                        </br>
                        <?php if($refund->refundPhoto!=null): ?>
                        <img src="<?php echo e(Storage::url($refund->refundPhoto)); ?>" alt="Refund Photo">
                        <?php endif; ?>
                    </td>
                </tr>
        ...
        <div>
            <form action="<?php echo e(route('refunds.reject')); ?>" method="post" id="rejectForm">
                <?php echo csrf_field(); ?>
                <div class="btn-container">
                    <input type="hidden" name="refundID" id="refundID" value="<?php echo e($refund->refundID); ?>">
                    <?php if($refund->refundStatus == "Approved"): ?>
                    <!-- Display information or message indicating that the status is completed -->
                    <span class="text-muted">Refund Approved</span>
                    <?php elseif($refund->refundStatus == "Rejected"): ?>
                    <!-- Display information or message indicating that the status is completed -->
        ...
        <div class="modal fade" id="adminRefundConfirmationModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>Refund to Tenant Name: <strong><?php echo e($refund->propertyRental->tenant->tenantName); ?></strong></p>
                        <p>Refund Amount: <strong>RM <?php echo e($refund->propertyRental->payment->paymentAmount); ?></strong></p>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="<?php echo e(route('refunds.approve')); ?>" method="post" id="approveRefundForm">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="refundID" id="refundID" value="<?php echo e($refund->refundID); ?>">
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/admin/refundProcess.blade.php ENDPATH**/ ?>