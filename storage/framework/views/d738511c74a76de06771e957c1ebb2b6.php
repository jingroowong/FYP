...
<?php if(session('tenant') && Str::startsWith(auth()->user()->id, 'TNT')): ?>
...
<div class="messenger">
    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : ''); ?>">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">RentSpace Chat System</span> </a>
...
<div class="messenger">
    ...
    <div class="messenger-listView <?php echo e(!!$id ? 'conversation-active' : ''); ?>">
        ...
        <div class="m-header">
            ...
            <input type="text" class="messenger-search" placeholder="Search Agent Here" />
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-header m-header-messaging">
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                    <a href="#" class="add-to-favorite"><i class="fas fa-star"></i></a>
                    <a href="<?php echo e(route('MyAgentAccount', ['id' => Auth::user()->id])); ?>"><i class="fas fa-home"></i></a>
                    <a href="#" class="show-infoSide"><i class="fas fa-info-circle"></i></a>
                </nav>
            </nav>
...
<?php echo $__env->make('Chatify::layouts.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('Chatify::layouts.footerLinks', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/vendor/Chatify/pages/app.blade.php ENDPATH**/ ?>