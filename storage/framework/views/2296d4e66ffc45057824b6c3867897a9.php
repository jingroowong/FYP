...
<body>
    ...
    <div class="ml-5 mt-2 wallet">
        ...
        <div class="mb-4">
            <h2>Number of active property posts: <?php echo e(count($activeProperty)); ?></h2>
        ...
        <form method="POST" action="<?php echo e(route('posting.payment')); ?>" id="paymentForm">
            <?php echo csrf_field(); ?>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php $__currentLoopData = $activeProperty; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td>
                            <input type="checkbox" name="property[]" class="property-checkbox"
                                value="<?php echo e($property->propertyID); ?>">
                        </td>
                        <td><?php echo e($property->propertyID); ?></td>
                        <td> <img src="<?php echo e(Storage::url($property->propertyPhotos[0]->propertyPath)); ?>"
                                alt="Property Photo" width="100" height="80"></td>
                        <td><?php echo e($property->propertyName); ?></td>
                        <td>  <?php echo e(\Carbon\Carbon::parse($property->expiredDate)->format('Y-m-d')); ?>

                           (<?php echo e(\Carbon\Carbon::parse($property->expiredDate)->diffForHumans()); ?>)
                        </td>
                        <td>
                            <select name="duration[<?php echo e($property->propertyID); ?>]" class="form-control duration">
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/agent/walletPayment.blade.php ENDPATH**/ ?>