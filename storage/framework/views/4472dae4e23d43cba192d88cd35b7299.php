...
<body>
    ...
    <div class="container">
        <h2 class="mt-4 mb-4">Refund Application for <?php echo e($propertyRental->property->propertyName); ?></h2>

        <!-- Display Property Details -->

        <div class="property-details">
            <p><strong>Address:</strong> <?php echo e($propertyRental->property->propertyAddress); ?></p>
        </div>

        <div class="row">
            <!-- Display Property Photo -->
            <div class="col-md-9 propertyPhoto">
        ...
        <form action="<?php echo e(route('refunds.store')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="row">
                    ...
                    <div class="tenantDetails">
                        ...
                        <table>
                            <tr>
                                ...
                                <td> <?php echo e($propertyRental->tenant->tenantName); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <?php echo e($propertyRental->tenant->tenantEmail); ?></p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> <?php echo e($propertyRental->tenant->tenantPhone); ?></p>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <table>
                        <tr>
                            ...
                            <td> <?php echo e($propertyRental->property->agent->agentName); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td> <?php echo e($propertyRental->property->agent->agentEmail); ?></p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td> <?php echo e($propertyRental->property->agent->agentPhone); ?></p>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="row">
                ...
                <h3>Refund Reason</h3>
                <div class="appointment-step col-md-6" id="step-3">
                ...
                <div class="col-md-6">
                    <strong> <label for="photoUpload">Upload Supporting Photos:</label></strong>
                    <input type="file" class="form-control" id="photoUpload" name="photoUpload" accept="image/*">

                    <small class="text-muted">
                        You can upload photos to support your refund request.
                    </small>
                </div>
            </div>
            ...
            <div class="btn-container">
                <input type="hidden" name="propertyRentalID" id="propertyRentalID"
                    value="<?php echo e($propertyRental->propertyRentalID); ?>">

                <button type="submit" class="btn btn-warning px-3 mr-3" id="submitButton" disabled> Confirm </button>
                <a href="<?php echo e(route('applicationIndex')); ?>" class="btn btn-secondary px-3">
                    Cancel
                </a>
            </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/refundCreate.blade.php ENDPATH**/ ?>