...
<body>
    ...
    <div class="container">
    <div class="container">
        <a href="<?php echo e(route('propertyList')); ?>" class="btn btn-secondary mb-3">
        ...
        <div class="container-sm">
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    ...
                    <h1 class="title"><?php echo e($property->propertyName); ?> <i class="fas fa-bookmark wishlist-star" title="Add to Wishlist"
                ...
                <div class="col-6 col-md-4 ">
                    ...
                    <?php if($property->propertyAvailability!=1): ?>
                    <div class="rentButton d-flex justify-content-center">
                        <a href="#" class="btn btn-danger btn-lg disabled">N/A</a>
                    </div>

                    <?php elseif($property->propertyRental!=null&&$property->propertyRental->tenantID==session('tenant')->tenantID&&$property->propertyRental->rentStatus=="Applied"): ?>
                    <div class="rentButton d-flex justify-content-center">
                        <a href="#" class="btn btn-danger btn-lg disabled">Your application submitted...</a>
                    </div>

                    <?php elseif($property->propertyRental!=null&&$property->propertyRental->rentStatus=="Approved"): ?>

                    <div class="rentButton d-flex justify-content-center">
                        <a href="<?php echo e(route('payments.create', $property->propertyRental->propertyRentalID)); ?>"
                    ...
                    <?php else: ?>
                    <div class="rentButton d-flex justify-content-center">
                        <a href="<?php echo e(route('properties.apply', ['propertyID' => $property->propertyID])); ?>"
                ...
                <div class="col-6 col-md-4 agentProfile">
                    ...
                    <div class="card-header row">
                        <div class="col-2">
                            ...
                            <img class="avatar" src="<?php echo e(asset('storage/'. $agent->photo)); ?>" alt="Agent Photo">
                            <?php else: ?>
                            <img class="avatar" src="<?php echo e(asset('storage/users-avatar/agent.png')); ?>" alt="Default Image">
                            <?php endif; ?>
                        </div>
                        <div class="col-10">
                            ...
                            <p class="card-text">
                                <small class="text-muted">
                                    <?php echo e(empty($agent->licenseNum) ? '#' : $agent->licenseNum); ?>
                    ...
                    <div class="card-body text-center agentBtn">
                        <a href="<?php echo e(route('appointment.create', ['propertyID' => $property->propertyID])); ?>"
                            class="btn btn-primary"> Book Appointment </a>

                        <a href="<?php echo e(route('AgentDetails', ['id' => $agent->agentID])); ?>" class="btn btn-primary"> View
                            agent profile</a>

                        <a href="<?php echo e(route('start.chat', ['userId' => $agent->agentID])); ?>" class="btn btn-primary">Send
                            Enquiry</a>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/propertyDetail.blade.php ENDPATH**/ ?>