...
<!-- Search Bar -->
<form action="<?php echo e(route('notifications.tenantSearch')); ?>" method="GET" class="mb-3" id="searchForm">
    <div class="input-group">
        <input type="text" name="search" class="form-control" placeholder="Search notifications" value="<?php echo e(isset($searchTerm) ? $searchTerm : ''); ?>">
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/notificationIndex.blade.php ENDPATH**/ ?>