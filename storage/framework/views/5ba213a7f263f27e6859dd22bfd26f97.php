...
<div class="row">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('agent.registerByAdmin')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                placeholder="Enter Agent Phone Number (Eg: 01x-xxxxxxx)" value="<?php echo e(old('agentPhone')); ?>"
                                required>
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/admin/agentCreate.blade.php ENDPATH**/ ?>