...
<body>
    ...
    <div class="container">
        <a href="<?php echo e(route('appointments')); ?>" class="btn btn-secondary mb-3">
    ...
    <hr class="mb-5">
        <div class="row">
            ...
            <div class="col-md-6 mb-5">
                    <form action="<?php echo e(route('appointments.update', $appointment->appID)); ?>" method="get">
                        <?php echo csrf_field(); ?>
                ...
                <div class="row mt-3">
                    ...
                    <div class="preview-details col-6 px-5">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <strong>Message to agent: </strong>
                                </td>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/appointmentUpdate.blade.php ENDPATH**/ ?>