...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" action="<?php echo e(route('properties.store')); ?>" enctype="multipart/form-data">
            ...
            <div id="stage-1" class="stage <?php echo e($errors->has('propertyPhotos') && $errors->first('propertyPhotos') ? 'hidden' : ''); ?>">
                </br>
                ...
                <?php if($walletBalance <= 10.00): ?> <!-- Display message and button to redirect to wallet top-up page -->
                    <div class="alert alert-danger">
                        Your wallet balance is insufficient. Please
                        <a href="<?php echo e(route('topUpMoney')); ?>" class="alert-link">[Top up Wallet]</a>.
                    </div>
                    <?php else: ?>
                    <div class="alert alert-info">
...
unset($__errorArgs, $__bag); ?>"
                                id="propertyName" name="propertyName" value="<?php echo e(old('propertyName')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="propertyDesc"
                                name="propertyDesc" rows="4"><?php echo e(old('propertyDesc')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                id="propertyAddress" name="propertyAddress" value="<?php echo e(old('propertyAddress')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="stateID"
                                name="stateID">
                                <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($state->stateID); ?>" <?php echo e(old('stateID')==$state->stateID ? 'selected' :
...
unset($__errorArgs, $__bag); ?>" id="propertyType"
                                ...
                                <option value="Residential apartment" <?php echo e(old('propertyType')=='Residential apartment'
                                    ? 'selected' : ''); ?>>Residential apartment</option>
                                <option value="House" <?php echo e(old('propertyType')=='House' ? 'selected' : ''); ?>>House
                                </option>
                                <option value="Condominium" <?php echo e(old('propertyType')=='Condominium' ? 'selected' : ''); ?>>
                                    Condominium</option>
                                <option value="Commercial spaces" <?php echo e(old('propertyType')=='Commercial spaces'
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control" id="roomType" name="roomType">
                                <option value="Unit" <?php if(old('roomType')=='Unit' ): ?> selected <?php endif; ?>>Unit</option>
                                <option value="Small Room" <?php if(old('roomType')=='Small Room' ): ?> selected <?php endif; ?>>Small
                                    Room</option>
                                <option value="Medium Room" <?php if(old('roomType')=='Medium Room' ): ?> selected <?php endif; ?>>Medium
                                    Room</option>
                                <option value="Big Medium Room" <?php if(old('roomType')=='Big Medium Room' ): ?> selected
                                    <?php endif; ?>>Big Medium Room</option>
                                <option value="Master Room" <?php if(old('roomType')=='Master Room' ): ?> selected <?php endif; ?>>Master
                                    Room</option>
                            </select>
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                id="squareFeet" name="squareFeet" value="<?php echo e(old('squareFeet')); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="furnishingType" id="fullyFurnished"
                                    ...
                                    <?php echo e(old('furnishingType') == 'Fully Furnished' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="furnishingType" id="partialFurnished"
                                    ...
                                    <?php echo e(old('furnishingType') == 'Partial Furnished' ? 'checked' : ''); ?>>
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="furnishingType" id="unfurnished"
                                    value="Unfurnished" <?php echo e(old('furnishingType') == 'Unfurnished' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                id="buildYear" name="buildYear" value="<?php echo e(old('buildYear')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="rentalAmount"
                                name="rentalAmount" value="<?php echo e(old('rentalAmount')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="depositAmount"
                                name="depositAmount" value="<?php echo e(old('depositAmount')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="facilities[]"
                                    value="<?php echo e($facility->facilityID); ?>"
                                    <?php echo e(in_array($facility->facilityID, old('facilities', [])) ? 'checked' : ''); ?>>
            ...
            <div class="stage <?php echo e($errors->has('propertyPhotos') && $errors->first('propertyPhotos') ? 'hidden' : ''); ?>"  id="stage-2">
                <h3>Stage 2: Upload Photos</h3>

                <!-- Property Photos (File Upload) -->
                <div class="form-group col-md-6">
                    <label for="propertyPhotos">Property Photos</label>
                    <input type="file" class="form-control <?php $__errorArgs = ['propertyPhotos[]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    ...
                    <?php $__errorArgs = ['propertyPhotos[]'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="stage hidden" id="stage-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Your current wallet balance: RM <?php echo e($walletBalance); ?></p>
                        <p>Posting Fee: RM 10.00 for the first 7 days of posting</p>
                        <hr>

                        <!-- Check if wallet balance is sufficient -->
                        <?php if($walletBalance >= 10.00): ?>
                        ...
                        <div class="alert alert-danger">
                            Your wallet balance is insufficient. Please
                            <a href="<?php echo e(route('topUpMoney')); ?>" class="alert-link">top up your wallet</a>.
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/agent/propertyCreate.blade.php ENDPATH**/ ?>