<link rel="stylesheet" href="<?php echo e(asset('/storage/css/HomePage.css')); ?>" media="screen">
...
<div class="clearfix">
    ...
    <div class="topImage" style="background-image: url('<?php echo e(asset('storage/images/brt.png')); ?>');">
        ...
        <div class="search-container text-center">
            ...
            <form method="GET" action="<?php echo e(route('home.search')); ?>" class="search-form">
                <?php echo csrf_field(); ?>
            ...
            <div class="content-box ab">
                ...
                <div class="content-box a">
                    ...
                    <div class="abox-description">
                        ...
                        <div class="description-image">
                            <img src="<?php echo e(asset('storage/images/agreement.png')); ?>" alt="Description">
                        </div>
                    </div>

                    <a class="link-button" href="<?php echo e(route('AgentLists')); ?>">Explore Agent</a>
                </div>
                ...
                <div class="content-box b">
                    ...
                    <div class="abox-description">
                        ...
                        <div class="description-image">
                            <img src="<?php echo e(asset('storage/images/request.png')); ?>" alt="Description">
                        </div>
                    </div>
                ...
                <div class="content-box c-content">
                    ...
                    <div class="cbox-description">
                        ...
                        <div class="cbox-description-image">
                            <img src="<?php echo e(asset('storage/images/house.png')); ?>" alt="Description">
                        </div>
                    </div>

                    <a class="cbox-link-button" href="<?php echo e(route('PropertyDetails')); ?>">Find Out More</a>
    ...
    <div class="recommend-p">
         ...
         <div class="property-container">
            ...
            <?php if($result): ?>
                    <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="property-card" onclick="redirectToPropertyPage('<?php echo e($property->propertyID); ?>')">
                    <img class="property-img" src="<?php echo e(Storage::url($property->propertyPhotos[0]->propertyPath)); ?>" alt="Property 3">
                    <p><strong><?php echo e($property->propertyAddress); ?></strong></p>
                    <p class="rental-fee"><strong>Rental Amount:</strong> <?php echo e($property->rentalAmount); ?></p>
                    <p class="desc"><?php echo e($property->propertyDesc); ?></p>
                    <p><strong><?php echo e($property->propertyType); ?> - <?php echo e($property->housingType); ?></strong></p>
                    <p style="font-style:italic;">Room Type: <?php echo e($property->roomType); ?></p>
                    </div>
...
<script>
    ...
    function redirectToPropertyPage(propertyId) {
        var propertyPageRoute = "<?php echo e(route('properties.show', ':id')); ?>";
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/tenant/HomePage.blade.php ENDPATH**/ ?>