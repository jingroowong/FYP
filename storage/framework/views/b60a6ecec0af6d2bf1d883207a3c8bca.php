...
<body>
    ...
    <div class="ml-5 mt-2">
        ...
        <p>Your Current Wallet Balance: RM <?php echo e($agentWallet->balance); ?></p>
                            ...
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                ...
                                <div class="form-group">
                                    <form action="/session" method="POST">
                                        ...
                                        <input type="hidden" name="productname" value="<?php echo e($agentWallet->walletID); ?>">
...
<?php echo $__env->make('layouts.adminApp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rentalsystem\resources\views/agent/walletTopUp.blade.php ENDPATH**/ ?>