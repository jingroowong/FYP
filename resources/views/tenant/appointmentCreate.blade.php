...
<body>
    ...
    <div class="container">
        ...
        <p>Property Name : <strong>{{ $property->propertyName }}</strong> </p>
            <p> Property Address : <strong>{{ $property->propertyAddress }}</strong> </p>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="appointment-step" id="step-2">
                        ...
                        <input type="text" class="form-control" name="name" id="name" value="{{$tenant->tenantName}}"
                            required />

                        <label for="email">Email:</label>
                        <input type="email" class="form-control" name="email" id="email"
                            value="{{$tenant->tenantEmail}}" required />

                        <label for="contact_number">Contact Number:</label>
                        <input type="tel" class="form-control" name="contact_number" id="contact_number"
                            value="{{$tenant->tenantPhone}}" required />
