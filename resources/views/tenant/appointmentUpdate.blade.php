...
<body>
    @section('content')
    <div class="container">
        <a href="{{ route('appointments') }}" class="btn btn-secondary mb-3">
                    ...
                    <div class="preview-details col-6 px-5">
                        <table class="table">
                            <tr>
                                ...
                                <td> {{ $appointment->property->propertyName }}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td> {{ $appointment->property->propertyAddress}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>{{$appointment->timeslot->startTime}} - {{$appointment->timeslot->endTime}}
                                </td>
                            </tr>
