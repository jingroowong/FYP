...
<link rel="stylesheet" href="{{ asset('/storage/css/CompareProperty.css') }}" media="screen">
<link rel="stylesheet"
...
<div class="compare-container">
    <div class="row">
        <div class="col selected-compare" id="property1">
            <img id="plus-img1" src="{{ asset('storage/images/plus.png') }}"
                onclick="toggleCompare('{{ session('tenant')->tenantID }}', 1)">
            <p>Select Rental Property</p>
        </div>
        <div class="col selected-compare" id="property2">
            <img id="plus-img2" src="{{ asset('storage/images/plus.png') }}"
                onclick="toggleCompare('{{ session('tenant')->tenantID }}', 2)">
            <p>Select Rental Property</p>
        </div>
        <div class="col selected-compare" id="property3">
            <img id="plus-img3" src="{{ asset('storage/images/plus.png') }}"
                onclick="toggleCompare('{{ session('tenant')->tenantID }}', 3)">
            <p>Select Rental Property</p>
        </div>
        <div class="col">
                    ...
                    <div class="latest-property-container" onclick="selectProperty('${property.propertyID}', '${propertyNumber}', '${property.propertyPhotoPath}')">
                            <div class="latest-property">
                                <div class="latest-property-image">
                                    <img id="propertyImage${propertyNumber}" src="{{ asset('storage/') . '/' }}${property.propertyPhotoPath}" alt="Property Image">
...
function selectProperty(propertyID, propertyNumber, propertyPath) {
    ...
    plusIconImage.src = `{{ asset('storage/') . '/' }}${propertyPath}`;
            ...
            for (let i = 1; i <= 3; i++) {
                if (selectedProperties[i]) {
                    ...
                    let attributeValue =
                        ...
                        `<img src="{{ asset('storage/') . '/' }}${selectedProperties[i].propertyPath}" style="height:150px; width:285px;" alt="Property Outlook">` :
