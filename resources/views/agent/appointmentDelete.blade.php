        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                @if($appointment->status == "Pending")
                    ...
                    <a href="{{ route('appointments.agentIndex') }}" class="btn btn-secondary">Back</a>
                    <a href="{{ route('appointments.agentCancel', $appointment->appID)}}" class="btn btn-danger"> Confirm
                        Cancel</a>
                        @else
                        <p>The appointment had {{$appointment->status}}.</p>
                        @endif
                </div>
