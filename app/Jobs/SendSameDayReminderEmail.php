...
class SendSameDayReminderEmail implements ShouldQueue
{
    ...
    {
        $header = 'Reminder for Appointment Today.';
        ...
        $note = "If you are unable to attend the appointment, please log in to your account to modify the appointment time.";
        ...
        try {
            ...
            Mail::send('emailContent', ['imagePath' => $imagePath, 'emailContent' => $emailContent, 'header' => $header, 'desc' => $desc, 'note' => $note], function ($message) use ($tenantEmail) {
                ...
                $message->subject('Reminder for Appointment Today.');
            });
